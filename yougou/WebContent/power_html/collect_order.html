...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/yougou/css/collect-order.css"/>
	</head>
	<body>
		<!--头部-->
		<div class="header">
		...
		<section>
			<div class="container">
				...
				<div class="row col-lg-10 col-lg-offset-1">
					<p class="curmbs">
						您当前的位置：
						<a href="/yougou/base_html/index.html" target="_blank">首页</a>
						>
				...
				<div class="row">
					...
					<div class="umenu col-lg-2 col-lg-offset-1" id="umenu ">
						...
						<ul class="jiaoyizx">
							...
							<li class="present myorder"><a href="/yougou/power_html/collect_order.html">
								<span>
								我的订单
							</span></a></li>
					...
					<div class="content col-lg-9" id="content">
						...
						<div class="content-top">
							...
							<div class="order-select">
								<p>显示：</p>
								<div class="order-time dropdown">
									<button class="btn btn-default dropdown-toggle overflow" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
   															六个月内订单
    									<span class="caret"></span>
  									</button>
  									<ul class="dropdown-menu"aria-labelledby="dropdownMenu1">
   									 	<li><a href="#">六个月内订单</a></li>
    									<li><a href="#">今年内其它订单</a></li>
    									<li><a href="#">2018</a></li>
  									</ul>
								</div>
								<div class="order-style dropdown">
						...
						<div class="content-body">
							...
							<div class="body-middle">
								<p>您最近没购买过任何商品，先去<a href="index.html">挑选商品</a>吧！~</p>
							</div>
						</div>
					</div>
				</div>
