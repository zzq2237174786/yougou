			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="umenu col-lg-2 col-lg-offset-1" id="umenu ">
						<!--我的优购-->
						<div class="myyougou ">
							<a class="text_center" href="/yougou/power_html/collect_my.jsp ">
								<span class="text_center">我的优购</span>
							</a>
						</div>
						...
						<ul class="jiaoyizx">
							...
							<li class="present mycomment"><a href="/yougou/power_html/collect_comment.jsp"><span>
								商品评论/晒单
							</span></a></li>
						...
						<ul class="wodezc">
							...
							<li class="current mygiftcard"><a href="/yougou/power_html/collect-giftcard.jsp"><span>
								我的礼品卡
							</span></a></li>
					...
					<div class="content col-lg-9" id="content">
						<div class="content-title">
							<span >每个认真、精彩的评价/晒单最高可获得20积分</span>
						</div>
						<ul class="content-top">
							<li class="wait">待评价/晒单商品</li>
							<li class="already"><a href="javascript:void(0)">已评价/晒单商品</a></li>
						</ul>
						<table class="content-body">
							<thead>
								<tr>
									<th width="150">订单编号</th>
									<th width="410">订单商品</th>	
							...
							<tbody>
								<tr>
									<td colspan="4">
										<center>
											目前您还没有待评价的商品，先去<a href="javascript:void(0)">挑选商品</a>吧！
										</center>
									</td>
								</tr>
							</tbody>
