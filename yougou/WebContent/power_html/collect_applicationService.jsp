...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/yougou/css/collect_applicationService.css"/>
	</head>
	<body>
		<!--头部-->
		<div class="header">
				...
				<div class="row">
					...
					<div class="umenu col-lg-2 col-lg-offset-1" id="umenu ">
						...
						<ul class="shouhoufw">
							...
							<li class="present myaddress"><a href="/yougou/power_html/collect_applicationService.jsp"><span>
								申请退换货
							</span></a></li>
						</ul>
						<!--热门推荐-->
					...
					<div class="content col-lg-9" id="content">
						<div class="u-detail" style="height:125px">
							...
							<p> 1、我要申请退换货怎么操作？<a class="f_blue" href="https://www.yougou.com/help/returnprocess.jsp?t=157685136775610700" target="_blank">点此了解。</a></p>
						...
						<ul class="tab-con">
							<table class="tab-tb col-lg-12">
								...
								<tbody>
									<tr class="tr1">
										<td colspan="6">
											没有可申请退换货的订单！赶快去&nbsp;&nbsp;<a href="index.jsp" class="Blue">优购</a>&nbsp;&nbsp;选购吧~
										</td>
									</tr>
								</tbody>
