				...
				<div class="row">
					...
					<div class="umenu col-lg-2 col-lg-offset-1" id="umenu ">
						...
						<ul class="wodezc">
							...
							<li class="present mygiftcard"><a href="colect-giftcard.jsp"><span>
								我的礼品卡
							</span></a></li>
					...
					<div class="content col-lg-9" id="content">
						<div id="couponAD" style="padding-bottom: 20px; overflow: hidden; display: none;">
				             <a target="_blank" href="https://www.yougou.com/topics/1415244574206.html?t=15771679675093457"><img width="830" src="//i2.ygimg.cn/pics/shop/zt/qchd/141113/1190X391.jpg"></a>
				        </div>
						<div class="outarea">
				        	<div class="inarea">
				                <em>礼品卡编号：</em><input class="border_style" type="text" name="coupon" id="yhq_num">&nbsp;&nbsp;&nbsp;
						...
						<div class="tab_content" id="coupon_tab">
							<ul class="tab_top">
								<li id="changCoupon1" onclick="changCoupon(1)" class="on">可使用礼品卡</li>
								<li id="changCoupon0" onclick="changCoupon(0)">未激活礼品卡</li>
								<li id="changCoupon2" onclick="changCoupon(2)">已使用礼品卡</li>
								<li id="changCoupon3" onclick="changCoupon(3)">已过期礼品卡</li>
							</ul>
							<ul class="tab_con">
								<table class="tab_tb">
									<thead>
										<tr>
											<th style="width:128px;" class="llb">礼品卡编号</th>
											<th style="width:89px;">面额</th>
											<th style="width:89px;">余额</th>
											<th style="width:90px">使用条件</th>
											<th width="220">有效期</th>
											<th style="width:130px">使用范围</th>
											<th width="92">获取渠道</th>
											<th width="92">使用记录</th>
											<th style="width:96px" class="lrb">状态</th>
										</tr>
									</thead>
									<tbody>
									     	<tr><td colspan="9"><center><div id="remark">您暂无可使用优惠券</div></center></td></tr>
						        	</tbody>
								</table>
							</ul>
							<!-- 20条记录换页 -->
							...
							<div class="u_coupon_tips">
								<p class="tit">礼品卡温馨提示：</p>
								<p> 
									·礼品卡<span>不受网站活动限制</span>，单张订单只能使用一张礼品卡；<br>
					
									·不同的礼品卡使用规则不同，请您使用前详细阅读相应礼品卡的使用规则；<br>
									·请保证您的礼品卡在有效期内使用，过期即作废；<br>
									·礼品卡不得合并，不设找零，不可兑换现金；<br>
									·单张订单，礼品卡和优惠券可同时使用；<br>
									·如遇礼品卡使用问题，可直接与优购网客户服务中心联系，我们会竭诚为您服务。 <br>
								</p>
							</div>
							<!--礼品卡说明结束-->
						</div>
