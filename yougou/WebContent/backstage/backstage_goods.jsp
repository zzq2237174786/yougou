			...
			<div class="container">
				...
				<div class="col-lg-10 main-right">
					...
					<div class="select">
						...
						<!--<li>商品尺码：<input type="text" class="goodsSize" id="goodsSize"/></li>-->
						<li>
							库存数：<input type="text" class="goods-min" id="goods-min" />
						~<input type="text" class="goods-max" id="goods-max" />
						</li>
						<li><input type="button" class="goods-select" id="goods-select" value="查询" /></li>
						<li><input type="button" class="goods-add" id="goods-add" value="添加新商品" /></li>
					...
					<div class="tab-body col-lg-12">						
						<ul class="tab-detail">
							...
							<li class="goods-status">
								...
								<input class="btn btn-default btn-on" type="button" value="修改">
							</li>
